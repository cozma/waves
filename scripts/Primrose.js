  ...
  var texturePromise = cache(textureDescription, function () {
    if (typeof txt === "string" || txt instanceof Array || txt.length === 6) {
      ...
      if (txt instanceof HTMLCanvasElement || txt instanceof HTMLVideoElement || txt instanceof HTMLImageElement) {
        retValue = new three.Texture(txt);
...
function box(width, height, length, t, u, v) {
  ...
  return cache("BoxBufferGeometry(" + width + ", " + height + ", " + length + ", " + t + ", " + u + ", " + v + ")", function () {
    return new three.BoxBufferGeometry(width, height, length, t, u, v);
  });
}
...
function quad(width, height, options) {
  ...
  return cache("PlaneBufferGeometry(" + width + ", " + height + ", " + options.s + ", " + options.t + ", " + options.maxU + ", " + options.maxV + ")", function () {
    return fixGeometry(new three.PlaneBufferGeometry(width, height, options.s, options.t), options);
  });
}
...
var InsideSphereGeometry = function (_Geometry) {
  ...
  function InsideSphereGeometry(radius, widthSegments, heightSegments, phiStart, phiLength, thetaStart, thetaLength) {
    ...
    for (y = 0; y < heightSegments; y++) {
      ...
      for (x = 0; x < widthSegments; x++) {
        ...
        if (Math.abs(_this.vertices[v1].y) === radius) {
          ...
          uv1.x = (uv1.x + uv2.x) / 2;
          _this.faces.push(new three.Face3(v1, v3, v4, [n1, n3, n4]));
    ...
    _this.boundingSphere = new three.Sphere(new three.Vector3(), radius);
...
function ring(rInner, rOuter, sectors, rings, start, end) {
  ...
  return cache("RingBufferGeometry(" + rInner + ", " + rOuter + ", " + sectors + ", " + rings + ", " + start + ", " + end + ")", function () {
    return new three.RingBufferGeometry(rInner, rOuter, sectors, rings, start, end);
  });
}
...
three.BufferGeometry.prototype.colored = three.Geometry.prototype.colored = three.Mesh.prototype.colored = function (color, options) {
...
three.Object3D.prototype.emit = three.EventDispatcher.prototype.emit = function (evt, obj) {
  if (!obj) {
    obj = {};
  }
...
three.Object3D.prototype.dispatchEvent = three.EventDispatcher.prototype.dispatchEvent = function (evt) {
...
three.Object3D.prototype.watch = three.EventDispatcher.prototype.watch = function (child, events) {
  var _this = this;
...
three.Object3D.prototype.route = three.EventDispatcher.prototype.route = function (events, listener) {
  var _this2 = this;
...
three.Object3D.prototype.on = three.EventDispatcher.prototype.on = function (event, listener) {
...
three.Object3D.prototype.named = function (name) {
  this.name = name;
  return this;
};

three.Object3D.prototype.addTo = function (obj) {
  obj.add(this);
  return this;
};

three.Object3D.prototype.at = function (x, y, z) {
  this.position.set(x, y, z);
  return this;
};

three.Object3D.prototype.rot = function (x, y, z) {
  this.rotation.set(x, y, z);
  return this;
};

three.Object3D.prototype.scl = function (x, y, z) {
...
three.BufferGeometry.prototype.offset = function (x, y, z) {
...
three.BufferGeometry.prototype.textured = three.Geometry.prototype.textured = three.Mesh.prototype.textured = function (texture, options) {
  return textured(this, texture, options);
};

three.Euler.prototype.toString = three.Quaternion.prototype.toString = three.Vector2.prototype.toString = three.Vector3.prototype.toString = three.Vector4.prototype.toString = function (digits) {
  var parts = this.toArray();
  if (digits !== undefined) {
    for (var i = 0; i < parts.length; ++i) {
...
var Pointer = function (_Entity) {
  ...
  function Pointer(pointerName, color, highlight, s, devices, triggerDevices, options) {
    ...
    _this.picker = new three.Raycaster();
...
var Button3D = function (_Entity) {
  ...
  function Button3D(model, buttonName, options) {
    ...
    _this.options.colorUnpressed = new three.Color(_this.options.colorUnpressed);
    _this.options.colorPressed = new three.Color(_this.options.colorPressed);
...
var Sky = function (_Entity) {
  ...
  function Sky(options) {
    ...
    if (options.disableDefaultLighting) {
      ...
      _this.ambient = new three.AmbientLight(0xffffff, 0.5).addTo(_this);
...
var EMPTY_SCALE = new three.Vector3();
var IE_CORRECTION = new three.Quaternion(1, 0, 0, 0);
...
var DEG2RAD$2 = three.Math.DEG2RAD;
...
var FusionPoseSensor = function () {
  function FusionPoseSensor(options) {
    ...
    this.originalPoseAdjustQ.setFromAxisAngle(new three.Vector3(0, 0, 1), -window.orientation * DEG2RAD$1);
    ...
    this.predictedQ = new three.Quaternion();
    this.previousTimestampS = null;
  }
...
var BrowserEnvironment = function (_EventDispatcher) {
  ...
  function BrowserEnvironment(options) {
    ...
    if (_this.options.useFog) {
      _this.scene.fog = new three.FogExp2(_this.options.backgroundColor, 1 / Math.sqrt(_this.options.drawDistance));
    }
...
function vector(min, max) {
  return new three.Vector3().set(number(min, max), number(min, max), number(min, max));
}
